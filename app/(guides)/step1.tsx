            ...
            return (
              <TouchableOpacity
                ...
                <View className="flex-row items-center">
                    <View className={`w-12 h-12 rounded-xl items-center justify-center mr-4 ${isSelected ? 'bg-primary/10' : 'bg-muted/30'}`}>
                         <Icon name={option.icon as any} size={24} color={isSelected ? 'hsl(var(--primary))' : 'hsl(var(--muted-foreground))'} />
                    </View>
                    ...
                    <View className={`w-6 h-6 rounded-full border-2 items-center justify-center ml-2 ${isSelected ? 'border-primary bg-primary' : 'border-muted-foreground/30'}`}>
